...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-transparent">
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              >
                <div className="px-4 py-2 rounded-full bg-gradient-to-r from-blue-500/20 to-purple-500/20 border border-blue-500/30 text-blue-400 text-sm font-medium backdrop-blur-sm">
              ...
              >
                ...
                <p className="text-lg text-gray-400 max-w-lg leading-relaxed">
                  Passionate about creating beautiful, functional web experiences and extracting meaningful insights from data. Let's build something amazing together.
                </p>
              </motion.div>
              ...
              >
                ...
                <motion.button
                  className="px-8 py-4 border border-gray-600 text-gray-300 font-semibold rounded-full hover:border-blue-500 hover:text-blue-400 transition-all duration-300 flex items-center justify-center gap-2"
                  whileHover={{ scale: 1.05, y: -2 }}
                  whileTap={{ scale: 0.95 }}
              ...
              >
                <a
                  ...
                  className="w-12 h-12 rounded-full bg-gray-800 border border-gray-700 flex items-center justify-center text-gray-400 hover:text-white hover:border-blue-500 hover:bg-blue-500/10 transition-all duration-300"
                >
            ...
            >
              <div className="relative">
                ...
                {/* Profile Container */}
                <div className="relative w-80 h-80 md:w-96 md:h-96 rounded-full bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-700 flex items-center justify-center overflow-hidden">
                  ...
                  {/* Floating Elements */}
                  <motion.div
                    className="absolute top-10 right-10 w-16 h-16 bg-blue-500/20 rounded-lg flex items-center justify-center backdrop-blur-sm border border-blue-500/30"
                    animate={{
                      y: [-10, 10, -10],
                      rotate: [0, 5, -5, 0]
                    }}
                  ...
                  <motion.div
                    className="absolute bottom-10 left-10 w-16 h-16 bg-purple-500/20 rounded-lg flex items-center justify-center backdrop-blur-sm border border-purple-500/30"
                    animate={{
                      y: [10, -10, 10],
                      rotate: [0, -5, 5, 0]
                    }}
      ...
      {/* Stats Section */}
      <section className="py-16 px-4 md:px-8 bg-transparent relative">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              <motion.div
                key={index}
                className="text-center p-6 rounded-2xl bg-gray-800/50 border border-gray-700 hover:border-blue-500/50 transition-all duration-300"
                initial={{ opacity: 0, y: 20 }}
